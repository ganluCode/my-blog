 ...
 */
@EnableMy-BlogDoc(value = "admin", isMicro = false)
@EnableMy-BlogResourceServer
@SpringBootApplication
public class My-BlogBootApplication {

    public static void main(String[] args) {
        SpringApplication.run(My-BlogBootApplication.class, args);
    }
