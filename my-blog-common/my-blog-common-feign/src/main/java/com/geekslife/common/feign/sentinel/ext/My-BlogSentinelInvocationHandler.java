 ...
 */
@Slf4j
public class My-BlogSentinelInvocationHandler implements InvocationHandler {
	...
	My-BlogSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			My-BlogSentinelInvocationHandler other = (My-BlogSentinelInvocationHandler) obj;
