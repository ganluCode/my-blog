...
package com.geekslife.common.feign.sentinel.ext;
 ...
 * @date 2020/6/9
 */
public final class My-BlogSentinelFeign {

	private My-BlogSentinelFeign() {

	}

	public static My-BlogSentinelFeign.Builder builder() {
		return new My-BlogSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public My-BlogSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new My-BlogSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new My-BlogSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new My-BlogSentinelInvocationHandler(target, dispatch);
				}
