...
package com.geekslife.common.log.event;
...
import com.geekslife.admin.api.feign.RemoteLogService;
import com.geekslife.common.core.constant.SecurityConstants;
import com.geekslife.common.core.jackson.My-BlogJavaTimeModule;
import com.geekslife.common.log.config.My-BlogLogProperties;
...
public class SysLogListener implements InitializingBean {
	...
	private final My-BlogLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new My-BlogJavaTimeModule());
	}
