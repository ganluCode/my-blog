...
import com.geekslife.common.core.jackson.MyBlogJavaTimeModule;
import com.geekslife.common.log.config.MyBlogLogProperties;
...
public class SysLogListener implements InitializingBean {
	...
	private final MyBlogLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new MyBlogJavaTimeModule());
	}
