 ...
 */
@Slf4j
public class MyBlogSentinelInvocationHandler implements InvocationHandler {
	...
	MyBlogSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MyBlogSentinelInvocationHandler other = (MyBlogSentinelInvocationHandler) obj;
