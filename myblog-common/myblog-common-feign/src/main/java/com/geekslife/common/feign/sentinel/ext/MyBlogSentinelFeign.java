 ...
 * @date 2020/6/9
 */
public final class MyBlogSentinelFeign {

	private MyBlogSentinelFeign() {

	}

	public static MyBlogSentinelFeign.Builder builder() {
		return new MyBlogSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public MyBlogSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new MyBlogSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new MyBlogSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new MyBlogSentinelInvocationHandler(target, dispatch);
				}
